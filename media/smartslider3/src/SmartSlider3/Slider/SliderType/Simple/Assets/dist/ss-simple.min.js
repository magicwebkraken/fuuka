!(function (t) {
  ...
  var s,
    ...
    a = t.clearTimeout,
    r = i._N2,
    o = (t.requestAnimationFrame, h.createElement.bind(h), Object.assign),
    c = function (t, i) {
  ...
  (s = function () {
    ...
    "complete" === h.readyState || "interactive" === h.readyState
      ? s()
      : Document &&
        Document.prototype &&
        Document.prototype.addEventListener &&
        Document.prototype.addEventListener !== h.addEventListener
      ? Document.prototype.addEventListener.call(h, "DOMContentLoaded", s)
      : h.addEventListener("DOMContentLoaded", s),
    r.d(
      ...
      function () {
        function t(t, i) {
          switch (
            ...
            r.SmartSliderMainAnimationAbstract.prototype.constructor.call(
              this,
              t,
              i
            ),
            t.isAdmin ||
              t.disabled.postBackgroundAnimations ||
              !this.slider.parameters.postBackgroundAnimations ||
              ((this.isReverseAllowed = !1),
              (this.postBackgroundAnimation =
                new r.SmartSliderPostBackgroundAnimation(t, this))),
        ...
        return (
          (t.prototype = Object.create(
            r.SmartSliderMainAnimationAbstract.prototype
          )),
          (t.prototype.constructor = t),
          (t.prototype.changeTo = function (t, i, s, h) {
            this.postBackgroundAnimation &&
              this.postBackgroundAnimation.prepareToSwitchSlide(t, i),
              r.SmartSliderMainAnimationAbstract.prototype.changeTo.apply(
                this,
                arguments
              );
          }),
          ...
          (t.prototype.hideSlide = function (t) {
            r.MW.t(t.SMWs, { x: -1e5 * n2const.rtl.modifier });
          }),
          (t.prototype.showSlide = function (t) {
            r.MW.t(t.SMWs, { x: 0, y: 0 });
          }),
          (t.prototype.cleanSlideIndex = function (t) {
            this.hideSlide(this.slider.slides[t]);
          }),
          (t.prototype.revertTo = function (t, i) {
            r.MW.t(this.slider.slides[i].SMWs, { zIndex: "" }),
              this.hideSlide(this.slider.slides[i]),
              r.SmartSliderMainAnimationAbstract.prototype.revertTo.apply(
                this,
                arguments
              );
          }),
          ...
          (t.prototype.onChangeToComplete = function (t, i, s) {
            null !== this.reverseSlideIndex &&
              ...
              (this.reverseSlideIndex = null)),
              this.hideSlide(t),
              r.SmartSliderMainAnimationAbstract.prototype.onChangeToComplete.apply(
                this,
                arguments
              );
          }),
          (t.prototype.onReverseChangeToComplete = function (t, i, s) {
            this.hideSlide(t),
              r.SmartSliderMainAnimationAbstract.prototype.onReverseChangeToComplete.apply(
                this,
                arguments
              );
          }),
          ...
          (t.prototype._mainAnimationFade = function (t, i) {
            ...
            if (0 !== this.parameters.shiftedBackgroundAnimation) {
              ...
              if (
                ...
                a > 0 && this.timeline.shiftChildren(a),
          ...
          (t.prototype.__mainAnimationDirection = function (t, i, s, h) {
            ...
            (f[c] = u), (d[c] = -u), r.MW.t(n, { zIndex: 23 });
            var m = { zIndex: 23 };
            (m[c] = u), r.MW.t(a, m), t.unsetActive(), i.setActive();
            var p,
              S = this.adjustMainAnimation();
            if (
              ((v[c] = 0),
              this.timeline.fromTo(a, S.inDuration, f, v, S.inDelay),
              ...
              if (
                ("auto" === this.parameters.shiftedBackgroundAnimation
                  ? t.hasLayers()
                    ...
                    : (y = !0)
                  : (x = !0),
                this._currentBackgroundAnimation && x)
              ) {
            ...
            if (
              (this.timeline.to(n, S.outDuration, d, S.outDelay),
              ...
              if (
                ...
                (z[c] = u), r.MW.t(D, z);
                var w = {},
                  A = { snap: "x,y", ease: this.getEase() },
                  I = {},
                  k = { snap: "x,y", ease: this.getEase() };
                (A[c] = 0),
                  (w[c] = -u),
                  (k[c] = u),
                  (I[c] = 0),
                  p.h("mainAnimationStartIn", {
                    mainAnimation: this,
                  ...
                  this.reverseTimeline.fromTo(D, S.inDuration, w, A, S.inDelay),
                  this.reverseTimeline.fromTo(n, S.inDuration, I, k, S.inDelay);
            ...
            l(
              ...
              function (e) {
                var t = this.slider.slides[e.detail.previousSlideIndex],
                  i = this.slider.slides[e.detail.currentSlideIndex];
                r.MW.t(t.SMWs, { zIndex: "" }), r.MW.t(i.SMWs, { zIndex: "" });
              }.bind(this)
            ),
    ...
    r.d("SmartSliderResponsiveSimple", ["SmartSliderResponsive"], function () {
      ...
      return (
        ...
        (t.prototype.calculateResponsiveValues = function () {
          ...
          if (
            ((this.resizeContext.slideOuterWidth = n.width),
        ...
        (t.prototype.onStarterSlide = function (t) {
          this.slider.slides.forEach(function (t) {
            (t.SMWs = [r.MW.i(t.element, { x: "-10000px" })]),
              t.background &&
                t.SMWs.push(r.MW.i(t.background.element, { x: "-10000px" }));
          }),
            r.SmartSliderResponsive.prototype.onStarterSlide.apply(
              this,
              arguments
            ),
    ...
    r.d("SmartSliderSimple", ["SmartSliderAbstract"], function () {
      function t(t, i) {
        (this.type = "simple"),
          r.SmartSliderAbstract.prototype.constructor.call(
            this,
            t,
            o({ bgAnimations: 0, carousel: 1 }, i)
          );
      }
      return (
        ...
        (t.prototype.initResponsiveMode = function () {
          (this.responsive = new r.SmartSliderResponsiveSimple(
            this,
        ...
        (t.prototype.initMainAnimation = function () {
          !this.disabled.backgroundAnimations && this.parameters.bgAnimations
            ? (this.mainAnimation =
                new r.SmartSliderFrontendBackgroundAnimation(
                  this,
                  this.parameters.mainanimation,
                  this.parameters.bgAnimations
                ))
            : (this.mainAnimation = new r.SmartSliderMainAnimationSimple(
                this,
                this.parameters.mainanimation
              ));
        }),
        ...
        (t.prototype.getSlideBackgroundContainer = function () {
          return this.sliderElement.querySelector(".n2-ss-slider-3");
        }),
